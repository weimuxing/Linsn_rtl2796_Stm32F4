...
#define HdmiTx_Bank(x)		HdmiTx_Set(0x0F, 0x03, x)
...
#define HdmiTx_Wb(u8Offset, u8Count, pu8Data)	iTE_I2C_WriteBurst(HDMI_TX_ADR, u8Offset, u8Count, pu8Data)
#define HdmiTx_Rb(u8Offset, u8Count, pu8Data)	iTE_I2C_ReadBurst(HDMI_TX_ADR, u8Offset, u8Count, pu8Data)
#define HdmiTx_Set(u8Offset, u8InvMask, u8Data)	iTE_I2C_SetByte(HDMI_TX_ADR, u8Offset, u8InvMask, u8Data)
#define HdmiTx_W(u8Offset, u8Data)				iTE_I2C_WriteByte(HDMI_TX_ADR, u8Offset, u8Data)
#define HdmiTx_R(u8Offset)						iTE_I2C_ReadByte(HDMI_TX_ADR, u8Offset)
#endif
