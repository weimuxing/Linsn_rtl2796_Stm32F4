...
void HdmiRx_Init(IT6661_TypeDef IT6661_SEL);
...
#define HdmiRx_Wb(u8Offset, u8Count, pu8Data,device)	iTE_I2C_WriteBurst(HDMI_RX_ADR, u8Offset, u8Count, pu8Data,device)
#define HdmiRx_Rb(u8Offset, u8Count, pu8Data,device)	iTE_I2C_ReadBurst(HDMI_RX_ADR, u8Offset, u8Count, pu8Data,device)
#define HdmiRx_Set(u8Offset, u8InvMask, u8Data,device)	iTE_I2C_SetByte(HDMI_RX_ADR, u8Offset, u8InvMask, u8Data,device)
#define HdmiRx_W(u8Offset, u8Data,device)				iTE_I2C_WriteByte(HDMI_RX_ADR, u8Offset, u8Data,device)
#define HdmiRx_R(u8Offset,device)						iTE_I2C_ReadByte(HDMI_RX_ADR, u8Offset,device)
#endif
